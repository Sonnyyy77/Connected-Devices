...
char serviceUUID[] = "58b93a37-ef1d-41a3-97c9-08eb10272223";
...
char characteristicUUID[] = "68b93a37-ef1d-41a3-97c9-08eb10272223";
...
BLEIntCharacteristic testCharacteristic("68b93a37-ef1d-41a3-97c9-08eb10272223", BLERead | BLEWrite| BLENotify); //integers between -255 and 255
...
void setup() {
  ...
  BLE.setLocalName("Sonny's BLE Test");
...
//    testCharacteristic.writeValue(String(555));
  //  testCharacteristic.writeValue(123);//-255 - 255
  //  delay(1000);
  ...
  if (testCharacteristic.written()) {
    ...
    byte dataIn = testCharacteristic.value();
