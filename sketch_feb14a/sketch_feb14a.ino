...
void loop() {
  ...
  if (IMU.accelerationAvailable()) {
    ...
    udpClient.print("Tilting up ");
    udpClient.print(degreesX);
  ...
  if(y > 0.1){
    ...
    // Serial.println("  degrees");
    udpClient.beginPacket(server, port);
    udpClient.print("Tilting left ");
    udpClient.print(degreesY);
    udpClient.println(" degrees");
    udpClient.endPacket();
    }
  if(y < -0.1){
